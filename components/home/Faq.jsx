              ...
              <div className="lg:col-5 sticky-element">
                ...
                <div className="panel vstack items-start gap-2 uc-sticky">
                  <div className="cstack gap-1 py-1 px-3 border rounded-pill">
                    ...
                    <span className="fs-8 fw-bold text-uppercase">{t("faq.heading")}</span>
                  </div>
                  <h2 className="h3 lg:h2 m-0">{t("faq.subheading")}</h2>
                  <p className="fs-6 lg:fs-5">{t("faq.description")}</p>
                  <Link href={`/page-contact`} className="btn btn-sm lg:btn-md btn-primary px-3 mt-2">
