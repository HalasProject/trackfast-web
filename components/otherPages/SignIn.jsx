 ...
 const login = async () => {
  try {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/session`, {
      ...
      credentials: "include", // ⬅️ VERY IMPORTANT for cookies
    });
    ...
    // Now JSESSIONID is stored automatically as a cookie
    // You can redirect to dashboard or protected route
                    ...
                    <div className="panel z-1">
                      ...
                      >
                        <p className="fs-5 xl:fs-4 fw-medium">
                          "Our GPS solution simplifies security,
                          giving you real-time control over your ride."
                        </p>
                      ...
                      >
                        <input
                          className={`form-control h-48px w-full ${
                            error 
                              ? 'border-danger border-2 bg-white dark:bg-opacity-0 dark:text-white dark:border-danger' 
                              : 'bg-white dark:bg-opacity-0 dark:text-white dark:border-gray-300 dark:border-opacity-30'
                          }`}
                          type="email"
