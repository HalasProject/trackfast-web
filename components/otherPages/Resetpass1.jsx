  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage(errorData || "Failed to send password reset email. Please try again.");
        setIsError(true);
      }
    } catch (error) {
                ...
                <div className="panel vstack justify-center h-100 overflow-hidden">
                  ...
                  <div className="panel py-4 px-2">
                    ...
                    >
                      ...
                      {message && (
                        <div className={`alert ${isError ? 'alert-danger' : 'alert-success'} text-start`}>
                          {message}
                        </div>
                      )}
                      ...
                      <p className="mt-2 sm:m-0">
                        ...
                        <Link className="m-1 uc-link" href={`/sign-in`}>
                          Sign in
                        </Link>
                      </p>
                    </div>
