      ...
      <div className="section-outer panel py-6 xl:py-9 bg-secondary dark:bg-gray-800">
        ...
        <div className="container max-w-lg">
          <div className="section-inner panel">
            ...
            >
              <h2 className="h3 lg:h2 mb-4">How TrackFast helps</h2>
              <p className="fs-5 xl:fs-4 text-dark dark:text-white text-opacity-70">
                Teams use TrackFast to improve document workflows, insights, and
                speed while delivering an amazing experience for their
                customers. Businesses trust TrackFast’s all-in-one document
              ...
              <p className="fs-5 xl:fs-4 text-dark dark:text-white text-opacity-70">
                ...
                the idea of TrackFast was born. Today, TrackFast empowers teams to
